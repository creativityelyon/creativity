...
<section class="section">
  ...
  <div class="section-body">
      ...
      <div class="card">
        <div class="card-body">
          ...
          $('.btn-select').click(function(){
            var date1 = $('#date1').val();
            date1 = date1.split('-');
            window.location.href = "{{ url('daily_fit/staff/create') }}/"+date1[2]+"-"+date1[1]+"-"+date1[0];
          });
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="col-lg-12">
          <h4>Anda harus melakukan sebanyak : </h4>
            @if($results == 4)
            3
            @elseif($results == 3)
            4
        ...
        <div class="card-body">
          <form class="row" action="{{ url('/daily_fit/staff/store')}}" method="post">
            @csrf
