          ...
          <div class="card-body">
            <div style="width: 100%;">
              <div class="table-responsive">
                <form action="{{url('/staff/final/submit')}}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                  {{ csrf_field() }}
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $d->total_score }}
                          ...
                          <input type="hidden" name="gender[]" value="{{ ($d->jenis_kelamin == 'WANITA/FEMALE') ? 'Female' : 'Male'  }}">
                          <input type="hidden" name="syscabang_id[]" value="{{ $d->syscabang_id }}">
