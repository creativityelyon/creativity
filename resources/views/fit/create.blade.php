      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form class="row" action="{{ url('/fit_test')}}" method="post">
              @csrf
              ...
              <div class="form-group col-md-6">
                ...
                <span> Lari Bolak-Balik / Shutthel Run 40 m (5m x 8 kali)	</span>
              ...
              <div class="form-group col-md-6">
                <label for="">KEKUATAN (STRENGTH)</label> <br/>
                {{-- <span> a. Sit up 30 detik (SD)/ 60 detik (SMP-SMA)	</span> --}}
                <span>Plank</span>
              ...
              <div class="form-group col-md-6">
                <label for="">DAYA LEDAK (EXPLOSIVE POWER)</label> <br/>
                <span>Standing Broad Jump</span>
              {{-- <label for="">Loncatan 1</label> --}}
                ...
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                {{-- <label for="">Loncatan 2</label>
                <input type="number" min="0" class="form-control mb-2 mr-sm-2   @error('test_3_2') is-invalid @enderror"
                name="test_3_2" id="test_3_2"
                maxlength="4">
                @error('test_3_2')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <label for="">Loncatan 3</label>
                <input type="number" min="0" class="form-control mb-2 mr-sm-2   @error('test_3_3') is-invalid @enderror"
                name="test_3_3" id="test_3_3"
                maxlength="4">
                @error('test_3_3')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror --}}
               ...
               <div class="form-group col-md-6">
                <label for="">KESEIMBANGAN (BALANCE)</label>
                <label for="">Stork Stand</label>
             ...
             {{--   <label for="">Berdiri satu kaki kanan</label>
