    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            @if(empty($data))
            <form class="" action="{{ url('/surveyTeacher')}}" method="post">
               @csrf
                ...
                <div class="form-group col-sm-6">
                  <label class="col-form-label pt-0">I confirm that I have not been in contact with a person who has been diagnosed with
                    ...
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="q2">
                        No, I made a contact with people diagnosed covid-19
                      </label>
                    </div>
                  </div>
                    ...
                    <div class="form-group col-sm-12">
                      ...
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="q4">
                          Yes, My body temperature is normal
                        </label>
                      </div>
                      <div class="form-check">
                  ...
                  <h3> You pass the qualification for today</h3>
                  @else
