@extends('layouts.app')
@section('title')
Survey Kesehatan Guru
@endsection
@section('content')
<section class="section">
  <div class="section-header">
    <h3 class="page__heading">Survey Kesehatan Guru</h3>
  </div>
  <div class="section-body">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <form class="row" action="{{ url('/kesehatan/guru')}}" method="post">
              @csrf
              <div class="form-group col-sm-12">
                <h1>DATA KESEHATAN GURU/STAFF (TEACHER/STAFF 𝘏𝘌𝘈𝘓𝘛𝘏 𝘋𝘈𝘛𝘈)</h1>
              </div>
              <div class="form-group col-sm-12">
                ...
                <div class="form-group col-sm-6">
                  ...
                  value="{{ (Auth::user()->nama_lengkap) ? Auth::user()->nama_lengkap : ""}}" >
                </div>
                <div class="form-group col-sm-6">
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="is_covid" name="is_covid" value="1">
                      <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="is_covid" name="is_covid" value="0">
